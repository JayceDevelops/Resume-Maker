...
export default function Button({text, type, onClick, active}) {
    ...
    let pw = type === 'continue' || type === 'back' ? 'p-1.5 w-32 sm:w-40 md:w-50' : 'p-3 w-full sm:w-75';
    ...
    if (type === 'continue' || type === 'save'){
        ...
        return (
            <div className='flex justify-center items-center border-2 border-indigo-600 p-1.5 rounded-xl w-24 sm:w-25 cursor-pointer shadow-grey-100 text-black font-bold hover:-translate-y-1 hover:shadow-[0_6px_16px_rgba(0,0,0,0.4)] active:shadow-[0_2px_6px_rgba(0,0,0,0.2)] transition-all' onClick={onClick}>
