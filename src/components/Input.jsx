export default function Input({lblText, value, placeholder, onChange, onBlur, errorText}) {
    return (
        <div className='flex flex-col'>
            ...
            <input className='pl-3 p-1.5 bg-none border-1 border-slate-500 rounded-xl text-l text-black font-sans font-semibold focus: outline-indigo-600' value={value} placeholder={placeholder} onChange={onChange} onBlur={onBlur}></input>
